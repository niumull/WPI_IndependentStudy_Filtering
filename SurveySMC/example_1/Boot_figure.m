...
[x_n_1,~,~] = Bootstrap(Y_n,x_initial,N,t_1,mu,phi,sigma2);
[x_n_2,~,~] = Bootstrap(Y_n,x_initial,N,t_2,mu,phi,sigma2);
[x_n_3,~,~] = Bootstrap(Y_n,x_initial,N,t_3,mu,phi,sigma2);
[x_n_4,~,~] = Bootstrap(Y_n,x_initial,N,t_4,mu,phi,sigma2);
...
[~, w_1, x_T_1] = Bootstrap(Y_n,x_initial_1,N_1,T,mu,phi,sigma2);
[~, w_2, x_T_2] = Bootstrap(Y_n,x_initial_2,N_2,T,mu,phi,sigma2);
[~, w_3, x_T_3] = Bootstrap(Y_n,x_initial_3,N_3,T,mu,phi,sigma2);
[~, w_4, x_T_4] = Bootstrap(Y_n,x_initial_4,N_4,T,mu,phi,sigma2);
